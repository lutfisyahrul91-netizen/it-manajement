        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
            ...
            <div style="display: flex; align-items: center; gap: 24px; flex-wrap: wrap;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; border: 1px solid #9E9E9E; padding: 8px 12px; border-radius: 8px; width: 250px;">
                    ...
                    <input type="text" placeholder="Search divisi..." style="border: none; background: transparent; outline: none; font-family: 'Montserrat'; font-size: 12px; color: #9E9E9E; width: 100%;">
                </div>
            </div>
            ...
            <button style="background: #D30007; color: white; border: none; padding: 10px 16px; border-radius: 8px; font-family: 'Montserrat'; font-weight: 700; font-size: 12px; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: background 0.2s;" onmouseover="this.style.background='#b00006'" onmouseout="this.style.background='#D30007'">
                <i class='bx bx-plus' style="font-size: 16px;"></i> Tambahkan Divisi
            </button>
        </div>
            ...
            <table style="width: 100%; border-collapse: collapse; min-width: 900px;">
                <thead>
                    <tr style="text-align: left; border-bottom: 1px solid #E9EAEC;">
                        <th style="padding: 16px; font-size: 14px; font-weight: 700; color: black; text-align: center;">Kode</th>
                        <th style="padding: 16px; font-size: 14px; font-weight: 700; color: black;">Nama Divisi</th>
                        <th style="padding: 16px; font-size: 14px; font-weight: 700; color: black; text-align: center;">Jumlah Anggota</th>
                        <th style="padding: 16px; font-size: 14px; font-weight: 700; color: black; text-align: center;">Jumlah Barang</th>
                ...
                <tbody>
                    ...
                    <tr style="background: {{ $loop->index % 2 == 0 ? '#F7F6FE' : 'white' }}; border-bottom: 1px solid #E9EAEC;">
                        ...
                        <td style="padding: 16px; font-size: 14px; font-weight: 500; text-align: center; color: black;">{{ $item->kode }}</td>
                        ...
                        <td style="padding: 16px; font-size: 14px; font-weight: 500; color: black; display: flex; align-items: center; gap: 8px;">
                            <div style="width: 32px; height: 32px; background: #C4C4C4; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                <i class='bx bx-buildings' style="color: white; font-size: 16px;"></i>
                            </div>
                            {{ $item->nama_divisi }}
                        </td>
                        
                        <td style="padding: 16px; font-size: 14px; font-weight: 500; color: black; text-align: center;">
                            <span style="background: #E0E0E0; color: #21252B; font-size: 12px; font-weight: 600; padding: 6px 14px; border-radius: 20px;">
                        ...
                        <td style="padding: 16px;">
                            @if($item->status == 'Pinjam')
                                <span style="background: #FEF2E5; color: #CD6200; font-size: 12px; font-weight: 500; padding: 6px 14px; border-radius: 20px;">Pinjam</span>
                            @else
                                <span style="background: #EBF9F1; color: #1F9254; font-size: 12px; font-weight: 500; padding: 6px 14px; border-radius: 20px;">Tidak Pinjam</span>
                            @endif
                        </td>
