...
<div style="display: flex; flex-direction: column; gap: 32px; font-family: 'Inter', sans-serif;">
    ...
    <div style="background: white; padding: 24px; border-radius: 8px; box-shadow: 0px 4px 20px rgba(0,0,0,0.05);">
            ...
            <table style="width: 100%; border-collapse: collapse; font-family: 'Montserrat', sans-serif; min-width: 900px;">
                <thead>
                    <tr style="text-align: left; border-bottom: 1px solid #E9EAEC;">
                        ...
                        <th style="padding: 16px; font-size: 14px; font-weight: 700;">Tahun Pengadaan <i class='bx bxs-sort-alt' style="color: #9E9E9E;"></i></th>
                        <th style="padding: 16px; font-size: 14px; font-weight: 700;">Pemeliharaan <i class='bx bxs-sort-alt' style="color: #9E9E9E;"></i></th>
                        ...
                        <th style="padding: 16px; font-size: 14px; font-weight: 700; text-align: center;">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr style="background: {{ $loop->index % 2 == 0 ? '#F7F6FE' : 'white' }}; border-bottom: 1px solid #E9EAEC;">
                        ...
                        <td style="padding: 16px; text-align: center;">
                            <div style="display: flex; justify-content: center; gap: 12px;">
                                <button style="width: 24px; height: 24px; background: transparent; border: 2px solid #624DE3; border-radius: 4px; cursor: pointer; display: flex; justify-content: center; align-items: center;">
                                    <i class='bx bx-edit-alt' style="color: #624DE3; font-size: 14px;"></i>
                                </button>
                                <button style="width: 24px; height: 24px; background: transparent; border: 2px solid #A30D11; border-radius: 4px; cursor: pointer; display: flex; justify-content: center; align-items: center;">
                                    <i class='bx bx-trash' style="color: #A30D11; font-size: 14px;"></i>
                                </button>
                            </div>
                        </td>
                    </tr>
        ...
        <div style="display: flex; justify-content: center; align-items: center; gap: 12px; margin-top: 24px;">
            ...
            <div style="padding: 8px 12px; background: #E0E0E0; color: black; border-radius: 8px; font-size: 12px; font-family: 'Montserrat'; font-weight: 500;">3</div>
